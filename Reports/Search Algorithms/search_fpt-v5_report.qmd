...
As info, this still any within-task difference in item time. Currently (total time from paper - startup time) / number of items.


## Same Order of Items, Randomly Selected

(This has not been rerun since adding startup cost!)
