...
[Live Web Demo](http://142.93.52.117/publix/a4rPAvPZgRV){.btn .btn-outline-primary .btn role="button" target="_blank"}
...
[Search Web Demo](http://142.93.52.117/publix/a4rPAvPZgRV?forceTask=search){.btn .btn-outline-primary .btn role="button" target="_blank"}
...
[Ridge Web Demo](http://142.93.52.117/publix/a4rPAvPZgRV?forceTask=ridge){.btn .btn-outline-primary .btn role="button" target="_blank"}
...
[xgboost Web Demo](http://142.93.52.117/publix/a4rPAvPZgRV?forceTask=xgboost){.btn .btn-outline-primary .btn role="button" target="_blank"}
